 ...
 * @author Arne
 */
public class AutoShooter implements Companion, Serializable {
    ...
    public AutoShooter(Player player, List<Bullet> bullets, List<Enemy> enemies, int height, int width, int damage, int bulletsPerMinute) {
        this.player = player;
        this.height = height;
        this.width = width;
